	...
	public function ctrRegistroUsuario(){
		...
		if(isset($_POST["regUsuario"])){
			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   preg_match('/^[^0-9][a-zA-Z0-9_-ñÑ]+([.][a-zA-Z0-9_-ñÑ]+)*[@][a-zA-Z0-9_-ñÑ]+([.][a-zA-Z0-9_-ñÑ]+)*[.][a-zA-ZñÑ]{2,4}$/', $_POST["regEmail"]) &&
			   preg_match('/^[a-zA-Z0-9ñÑ]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$mail->setFrom('rankshop@outlook.com', 'rankshop');

					$mail->addReplyTo('rankshop@outlook.com', 'rankshop');
					...
					$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
						...
						<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
							...
							<div style="line-height:60px; background:#FFCD00; width:60%; color:black">Verifique su dirección de correo electrónico</div>
							...
							<h5 style="font-weight:100; color:#999">Si no fuiste tu, puedes ignorar este correo electrónico y la cuenta se eliminará.</h5>
					...
					if($respuesta2  == "ok"){
						...
						$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
								...
								<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
									...
									<div style="line-height:60px; background:#FFCD00; width:60%; color:black">Ingrese nuevamente al sitio</div>
		...
		if(isset($_POST["editarNombre"])){
			...
			if(isset($_FILES["datosImagen"]["tmp_name"]) && !empty($_FILES["datosImagen"]["tmp_name"])){
				...
				if($_FILES["datosImagen"]["type"] == "image/jpeg"){
					...
					/*=============================================
					MOFICAMOS TAMAÑO Y PESO DE LA FOTO
					=============================================*/
		...
		if(isset($_POST['mensajeContactenos'])){
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["emailContactenos"])){
				...
				=============================================*/
					...
					$mail->addAddress("rankshop@outlook.com");
